...
export const primaryDark = {color: "#041d29", alpha: 1, rgb: "rgba(4, 29, 41, 1)"};
export const primaryDarkTransparent = { color: "#041d29", alpha: 0.5, rgb: "rgba(4, 29, 41, 0.5)"};
export const secondaryDark = { color: "#3f3f3f", alpha: 0.9, rgb: "rgba(63, 63, 63, 0.9)"};
export const thirdDark = { color: "#2e4052", alpha: 1, rgb: "rgb(46, 64, 82)"};
...
// Color for state mesages
export const primaryError = { color: "#ff0000", alpha: 1, rgb: "red" };
export const primarySuccess = { color: "#00ff00", alpha: 1, rgb: "green" };
