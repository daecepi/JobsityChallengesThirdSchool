  ...
  getReservationModule = () => {
    if (this.props.book.types === "Digital") {
      return (
        <ReadLaterContainer
          onClick={() => {
            this.displayNotification("Digital books cannot be lent");
          }}
        >
      ...
      return (
        <ReadLaterContainer
          onClick={() => {
            this.displayNotification("Book has been already lent");
          }}
        >
          <StyledI color={primaryError.rgb} className="fas fa-times fa-2x"></StyledI>}
        </ReadLaterContainer>
    ...
    return (
      <ReadLaterContainer onClick={this.handleReservationProccess}>
        ...
        <BookMenuContainer onClick={this.props.changeToogle} hidden={this.props.hidden}>
          ...
          <MidBookMenu>
            ...
            <ReturnBookContainer onClick={this.fetchReturnBook}>
              <StyledPOption>return</StyledPOption>
            </ReturnBookContainer>
          </MidBookMenu>
          <BottomBookMenu>
            <StarRatings
