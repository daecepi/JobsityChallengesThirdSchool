    ...
    return (
      <div className="general-hover-container">
        <div className="hover-desc">
          ...
          <p className="gray-hover-text left-gap">{typeof release !== "undefined" && release.indexOf >= '-' ? release.split('-')[0]: release}</p>
        </div>
        ...
        <div>
          ...
          <p>{typeof description !== "undefined" && description.length >= 250 ? description.substr(0, 250): description}</p>
        </div>
        <div>
